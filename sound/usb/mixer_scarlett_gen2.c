...
enum {
	...
	SCARLETT2_BUTTON_COUNT = 2,
};

static const char *const scarlett2_button_names[2] = {
	"Mute", "Dim"
};
 ...
 * FIXME: should these be looked up somehow?
 */
 ...
 * S/PDIF, then ADAT
 */
static void scarlett2_init_routing(__u8 *mux, const struct scarlett2_ports *ports)
{
